...
1. Create an `.env` file from `env.template`. If using a proxy service follow the format outlined in the env.template which uses JSON for the proxy configuration.
