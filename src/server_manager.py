...
class ServerManager:
    ...
    - Container identifiers:
      ...
      - HOSTNAME: the network hostname of the container, random string generated by nanoid.
        HOSTNAME stays the same after assignment or reload.
    ...
    - Containers can be reached by HOSTNAME on the network with settings.DOCKER_DOMAIN.
    ...
    async def _get_containers(
        ...
        *,
        ...
        filters = {"label": [f"com.docker.compose.service=mcp-getgather"]}
        if partial_name:
    ...
    async def _create_or_replace_container(
        ...
        config: dict[str, Any] = {
            ...
            "NetworkingConfig": {
                "EndpointsConfig": {
                    cls._network_name(): {"Aliases": [cls.external_hostname(hostname)]}
                }
            },
            "Labels": {
